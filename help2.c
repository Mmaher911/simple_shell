#include "main.h"
/**
 * help_all - Displays all possible builtin shell by all commands
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the shell by alias command
 */
...
/**
 * help_cd - Displays information on the shell by cd command
 */
void help_cd(void)
{
